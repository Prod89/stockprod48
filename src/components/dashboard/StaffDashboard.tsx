...
export function StaffDashboard() {
  return (
    <div className="p-6 flex flex-col justify-start items-center min-h-[85vh] gap-8 pt-10 pb-32">
      ...
      <Link href="/returns" className="w-full max-w-sm block">
        <div className="bg-gradient-to-r from-rose-600 to-rose-800 py-10 px-8 rounded-[2rem] shadow-xl shadow-rose-500/20 flex flex-col items-center justify-center gap-4 transition-transform active:scale-95 hover:scale-105 border border-rose-400/20">
          <svg className="w-14 h-14 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6" />
          </svg>
          <span className="text-white text-3xl font-bold tracking-wide">คืนของ</span>
        </div>
      </Link>
