            ...
            >
              ...
              <div className="flex items-center gap-3 px-4 pt-3 pb-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 text-xs font-medium text-indigo-300 hover:text-white bg-indigo-500/20 hover:bg-indigo-500/40 border border-indigo-500/30 px-3 py-2 rounded-xl transition-all active:scale-95 flex-shrink-0"
                >
